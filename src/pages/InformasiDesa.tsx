    ...
    <div className="p-8">
      ...
      <section className="flex flex-col gap-4">
        ...
        <section className="bg-white shadow-md rounded-xl p-6">
          ...
          <p className="text-gray-700 leading-relaxed">
            Kalirejo memiliki potensi besar dalam sektor pertanian, terutama
            padi dan jagung. Selain itu, desa ini juga berkembang dalam bidang
            ekonomi kreatif seperti kerajinan bambu, batik, dan olahan hasil
            tani.
          </p>
          <p className="mt-2 text-gray-700 leading-relaxed">
            Desa juga memiliki potensi wisata alam dengan lanskap sawah dan
            perbukitan yang masih asri, yang dapat dikembangkan sebagai
            agrowisata atau wisata edukasi pertanian.
          </p>
        </section>
      </section>
    </div>
