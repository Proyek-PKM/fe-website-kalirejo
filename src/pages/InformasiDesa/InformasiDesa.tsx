    ...
    <div className="flex flex-col  space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">
            Halaman ini digunakan untuk menampilkan dan mengelola berbagai
            informasi penting yang berkaitan dengan kegiatan, pengumuman, serta
            pelayanan di desa. Data disajikan secara jelas dan terstruktur agar
            memudahkan warga dalam memperoleh informasi terbaru mengenai
            administrasi, sosial, dan kegiatan masyarakat desa.
          </p>
        </div>
      </div>
      ...
      <div className="bg-white p-8 rounded-lg shadow-sm border border-neutral-100 text-center">
        ...
        <p className="text-neutral-600 mt-2">
          Informasi diperbarui setiap hari - hubungi kontor desa untuk informasi
          lebih lanjut
        </p>
      </div>
    </div>
